...
public class ParameterBindingTests {
    ...
    * */
    ...
    @Test
    void 위치_기준_파라미터_바인딩_메뉴_목록_여러개_조회_테스트(){
        // given
        String menuNameParameter1 = "한우딸기국밥";
        String menuNameParameter2 = "코다리마늘빵";
        // when
        String jpql = "SELECT m FROM menu_section02 m WHERE m.menuName = ?1 AND ?2";

        List<Menu> menuList = entityManager.createQuery(jpql, Menu.class)
                .setParameter(1, menuNameParameter1)
                .setParameter(2, menuNameParameter2).getResultList();
