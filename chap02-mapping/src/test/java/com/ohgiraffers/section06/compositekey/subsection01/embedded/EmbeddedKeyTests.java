...
public class EmbeddedKeyTests {
    ...
    * 이 방법은 복합 키의 일부 필드만을 매핑할 수도 있기 때문에, 필드 수가 많은 경우에는 유연한 매핑이 가능하다는 장점이 잇다.
    ...
    *
    * 복합 키의 매핑에서는 복합 키 클래스에 Equals와 hashCode 메소드를 구현해야 한다는 점에 주의해야 한다.
    * 이는 jpa에서 엔터티 객체의 통일성을 판단하기 위해 필요하다.
